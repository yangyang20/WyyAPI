...
func (l *SearchSuggestLogic) SearchSuggest(req types.SearchSuggestReq) (resp *types.SearchSuggestReply, err error) {
	res := Request("POST", "https://music.163.com/weapi/hotsearchlist/get", req, Options{
		Crypto: "weapi",
		Cookie: "",
		Proxy:  "",
		RealIP: "",
